...
- **`docs/`** - General documentation and guides
  ...
  - [Account Switching Guide](docs/account-switching.md) - как сменить GitHub аккаунт или переавторизоваться
...
**⚙️ Настройка GPT Actions:** 
- **OAuth 2.0 (рекомендуется):** [Полное руководство по OAuth](docs/oauth-setup.md) - пользователи авторизуются один раз, токены сохраняются для всех чатов
- **Альтернативные варианты:** [Общее руководство по настройке](docs/gpt-actions-setup.md)
