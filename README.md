...
**⚙️ Настройка GPT Actions:** Инструкции по выбору типа авторизации и настройке GPT Actions см. в [руководстве по настройке GPT Actions](docs/gpt-actions-setup.md). **Рекомендация:** Выберите "Ничего" (Nothing) для публичного GPT.
